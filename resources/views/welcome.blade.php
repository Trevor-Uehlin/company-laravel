        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0" style="text-align: center;">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                    <h1>Hello...welcome to trevoruehlin.com</h1>
                </div>

                @if (Route::has('login'))
                    <div class="" style="text-align: center;">
                        @auth
                            <a href="{{ url('/dashboard') }}" class="text-lg text-gray-700 dark:text-gray-500 underline">Go to dashboard</a>
                        @else
                            ...
                            @if (Route::has('guest'))
                                <a href="{{ route('register') }}" class="ml-4 text-lg text-gray-700 dark:text-gray-500 underline">Guest Log in</a>
                            @endif
