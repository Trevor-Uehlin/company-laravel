        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center logo-container">
                    <a href="/">
                        <x-application-logo class="nav-logo block h-8 w-auto fill-current text-gray-600" />
                        {{config("app.name")}}
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <div class="hidden sm:flex sm:items-center sm:ml-6">
                        <x-dropdown align="right" width="48">
                            ...
                            <x-slot name="content">
                                <x-dropdown-link :href="route('weather')" :active="request()->routeIs('weather')">
                                    {{ __('Weather') }}
                                </x-dropdown-link>

                                <x-dropdown-link :href="route('play/item/2')" :active="request()->routeIs('play/item/2')">
                                    {{ __('Playground Item 2') }}
                                </x-dropdown-link>
                            </x-slot>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <div class="sm:flex sm:items-center sm:ml-6">
                <x-dropdown align="is-responsive" width="48">
                    <x-slot name="trigger">
                        <button class="flex items-center text-sm font-medium text-gray-500 hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300 transition duration-150 ease-in-out">
                            Dev Playground
